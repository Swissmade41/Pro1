...
\usepackage{rotating, rotfloat,ragged2e, hyphenat, diagbox}
...
\include{sections/2_Loesungskonzept/Loesungskonzept}
\include{sections/3_Auswertung/Auswertung}
\include{sections/4_Detailkonzept/Detailkonzept}
\include{sections/5_Wirtschaftlichkeit/Wirtschaftlichkeit}
