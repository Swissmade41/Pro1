...
%TODO Lars: Begründen warum dieser hersteller/gleichrichter besser ist als andere und ds DCDC schon integriert ist
...
Die Kosten für die Komponenten betragen 5900 \si{Fr}. Für die Entwicklung der Software werden 3 PM benötigt, was einmalig 48'000\si{Fr} kostet. 
...
%TODO Lars: Anforderungen sind gegeben: Hersteller suchen und etwa Kosten schätzen (denke 5k etwa)
\paragraph{Umleitventil}

%TODO Michel: Genaues Ventil aussuchen. Anforderung 24V, Korrisionsbeständig
%Gibt es ein billigeres Ventil bei 74 Ventile und 2080 ist sind dies bisjetzt die grössten kosten
