...
\begin{figure}[h]
    ...
    \begin{minipage}[t]{0.45\linewidth}
    	\centering
    	\includegraphics[width=\linewidth]{Geberit_PE_Sovent_Formstueck.jpg}
    ...
    \begin{minipage}[t]{0.45\linewidth}
    	\centering
    	\includegraphics[width=\linewidth]{Direkte_Nebenlueftung.PNG}
    ...
    \begin{minipage}[t]{0.45\linewidth}
    	\centering
    	\includegraphics[width=\linewidth]{Indirekte_Nebenlueftung.PNG}
    ...
    \begin{minipage}[t]{0.45\linewidth}
    	\centering
    	\includegraphics[width=\textwidth]{Sekundaerlueftung.PNG}
