...
\hline
\cellcolor{grau} 
\textbf{1. Analyse}                                &\cellcolor{grau}\textbf{105}     &\multicolumn{5}{c}{\cellcolor{ddblau}}&&\multicolumn{2}{c}{\cellcolor{ddblau}}&&&&&&&&&\\
\cellcolor{hellgrau}  
\qquad 1.1. Lastenheft                             &\cellcolor{hellgrau}\textbf{55}      &\multicolumn{3}{c}{\cellcolor{dblau}}&&&&&&&&&&&&&&\\
...
\cellcolor{hellgrau} 
\qquad 1.2. Recherchearbeit                        &\cellcolor{hellgrau}\textbf{50} &&\multicolumn{4}{c}{\cellcolor{dblau}}&&\multicolumn{2}{c}{\cellcolor{dblau}}&&&&&&&&&\\
...
\qquad\qquad 1.2.6. Turbokompressor oder Netzeinspeisung & 1          &&&&&&&\multicolumn{2}{c}{\cellcolor{blau}}&&&&&&&&&\\
...
\cellcolor{grau} 
\textbf{2. Entwurf}                                  &\cellcolor{grau}\textbf{115}   &\multicolumn{4}{c}{\cellcolor{ddblau}}&&&\multicolumn{6}{c}{\cellcolor{ddblau}}&&&&&\\
...
\cellcolor{grau} 
\textbf{3. Projektmanagement}                        &\cellcolor{grau}\textbf{26}    &&&&&&&&&&&&&&&&&\\
